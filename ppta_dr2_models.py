...
from enterprise_warp.enterprise_warp.enterprise_models import StandardModels
from enterprise_warp.enterprise_warp.enterprise_models import selection_factory
...
class PPTADR2Models(StandardModels):
  ...
  def __init__(self,psr=None,params=None):
    ...
    for ky in ["fd_sys_slope_range","event_j0437_t0","event_j1643_t0","event_j1713_1_t0","event_j1713_2_t0","event_j2145_t0","event_j1603_t0"]:
        setattr(self.params,ky,self.priors[ky])
        
        

  def dm_annual(self, option="default"):
    if option=="default": idx = 2
    return chromatic.dm_annual_signal(idx=idx)
